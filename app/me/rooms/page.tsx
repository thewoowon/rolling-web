...
function MyRoomsInner() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-6 pt-12 pb-24">
      <h1 className="text-2xl font-semibold tracking-tight">참가 확정 룸</h1>
      <p className="mt-1 text-sm text-(--text-secondary)">결제 완료 또는 참가 확정된 룸을 모았습니다.</p>
            ...
            return (
              <div key={r.id} className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                  ...
                  <Link href={`/event/${r.id}/matches`}>
                    <Button size="sm" className="w-full" disabled={confirmed || inProgress}>
                      매치
                    </Button>
                  </Link>
                </div>
